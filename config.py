...
# Pure lexical index — no embeddings, fast to rebuild. Overridable via env so
# local setups with a differently-named index don't need a code change.
LEXICAL_INDEX = os.environ.get("LEXICAL_INDEX", "english-lexical")
